...
This will be another way to think about the study plan. This needs to be in relation to [Current Learning Objectives]({{< relref "current_learning_objectives.md" >}}). These are specific topics who can be separated into a specific single note, not full fields.
...
## Initial Learning Phase/Note Phase {#initial-learning-phase-note-phase}
...
- <span class="org-todo todo TODO">TODO</span>  (<a href="#citeproc_bib_item_1">Weng 2021</a>)

...
lastmod = 2022-10-27T20:19:20-06:00
slug = "hypothesis"
draft = false
notetype = "note"
+++
...
## What makes a good hypothesis? {#what-makes-a-good-hypothesis}
...
## Some examples (of good and bad) Hypothesis. {#some-examples--of-good-and-bad--hypothesis-dot}


### Reward hypothesis (bad) {#reward-hypothesis--bad}


### Predictive representation hypothesis (ok) {#predictive-representation-hypothesis--ok}


### Dopamine Reward Prediction Error Hypothesis (good) {#dopamine-reward-prediction-error-hypothesis--good}

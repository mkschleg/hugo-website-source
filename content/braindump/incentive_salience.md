...
Incentive Salience is an alternative to the [Reward Prediction-Error Hypothesis of Dopamine]({{< relref "reinforcement_learning_in_the_brain.md#reward-prediction-error-hypothesis-of-dopamine" >}}), and possibly a better fit for parts of the data (<a href="#citeproc_bib_item_2">Zhang et al. 2009</a>), (<a href="#citeproc_bib_item_1">Colombo 2014</a>).

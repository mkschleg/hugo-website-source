...
tags
: [Charles S. Peirce]({{< relref "charles_s_peirce.md" >}}), [Cognitive Science]({{< relref "cognitive_science.md" >}}), [Philosophy]({{< relref "philosophy.md" >}})

source
: <https://plato.stanford.edu/entries/peirce-semiotics/>

[Charles S. Peirce]({{< relref "charles_s_peirce.md" >}})'s [Semiotic]({{< relref "semiotic.md" >}}) is split into three parts, each signifying a different point in Peirce's life.
...
> I define a sign as anything which is so determined by something else, called its Object, and so determines an effect upon a person, which effect I call its interpretant, that the later is thereby mediately determined by the former (<a href="#citeproc_bib_item_1">Project 1998</a>).


### Representation or Sign-Vehicle {#representation-or-sign-vehicle}

...
Every [Partially Ordered Set]({{< relref "partially_ordered_set.md" >}})  gives rise to a dual (opposite) POS denoted by \\(P^{0p}\\) or \\(P^d\\). The dual order is defined to be the inverse of the original partially ordered set. While simple, this definition gives rise to the **Duality Principle** for ordered sets:
